...
def esearch(topic_input, nResults):
    ...
    base_url = 'https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pmc&api_key=c3b9ad9a1cb4e93717881a2421f597b1ae08&sort=relevance&retmax=' + nResults + '&term='
